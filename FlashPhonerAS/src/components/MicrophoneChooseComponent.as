package components
{
	...
	public class MicrophoneChooseComponent extends Sprite
	{
		...
		public function MicrophoneChooseComponent(_name:String)
		{
			...
			_holder.graphics.drawRoundRect(0, 0, 200, 22, 20, 20);
			...
			_overSprite.graphics.drawRoundRect(0, 0, 200, 22, 20, 20);
		...
		{
			TweenMax.to(_holder, 0.5, {tint:0xcccccc});
		}
		
		private function handleOut(event:MouseEvent):void
		{
			TweenMax.to(_holder, 0.5, {tint:0xeeeeee});
		}
	}
}
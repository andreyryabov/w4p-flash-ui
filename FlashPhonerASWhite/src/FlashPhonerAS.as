package
{
	...
	public class FlashPhonerAS extends Sprite
	{
		...
		private var _settingsFlag:Boolean = false;
		...
		public function FlashPhonerAS()
		{
			...
			_semiTransparentBackground.graphics.beginFill(0xdedfe2, 1);
			...
			if(isIVR)
			{
				_backgroundHolder.y = 303;
			}
			else
			{
				_backgroundHolder.y = 158;
			}
			...
			if(isIVR)
			{
				_settingsBackgroundHolder.y = 242;
			}
			else
			{
				_settingsBackgroundHolder.y = 97;
			}
			...
			if(isIVR)
			{
				_copyrightHolder.y = 522;
			}
			else
			{
				_copyrightHolder.y = 377;
			}
			
			_copyrightHolder.x = 62;
			
			_holder.addChild(_copyrightHolder);
			
			_linkButton = new Sprite();
			_linkButton.graphics.beginFill(0xff0000, 0);
			_linkButton.graphics.drawRect(0, 0, 107, 14);
...
//				_callButton.goCallOver();
		...
		private function showControls1():void
		{
		...
		private function showControls2():void
		{
			_text.visible = true;

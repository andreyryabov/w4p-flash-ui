package components
{
	...
	public class MicrophoneChoose extends Sprite
	{
		...
		public function MicrophoneChoose(arr:Array, _ind:int)
		{
			...
			_chooserOverSprite.graphics.drawRoundRect(0, 0, 204, 26, 20, 20);
			...
			_dropDownList.graphics.drawRoundRect(0, 0, 204, 26*_microphoneArray.length, 20, 20);
			...
			for(var i:uint = 0; i < _microphoneArray.length; ++i)
			{
				...
				_microphoneChooseComponent.y = 26 * i;
